...
function [params, stats, outputs, fig] = FOM_LMCalibration_LocalKp_3D(tumor, ntp_cal, ntp_pred, bounds, dt, workers)
...
%     alpha2_g = alpha_low * 5;
    alpha1_g = 0.1; alpha2_g = 0.1;
    
    num_kp = numel(idx_ROI);
    num_p  = num_kp + 3;
    
    %Initialize SSE
    [N_sim, TC] = RXDIF_3D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_g, tx_params, t, h, dz, dt, bcs);
...
%             start = tic;
            ...
            parfor(i = 1:num_kp)
                ...
                N_kp    = RXDIF_3D_wAC(N0, kp_p, d_g, alpha1_g, alpha2_g, tx_params, t, h, dz, dt, bcs);
...
%             end
            ...
            N_d      = RXDIF_3D_wAC(N0, kp_g, d_p, alpha1_g, alpha2_g, tx_params, t, h, dz, dt, bcs);
            N_alpha1 = RXDIF_3D_wAC(N0, kp_g, d_g, alpha1_p, alpha2_g, tx_params, t, h, dz, dt, bcs);
            N_alpha2 = RXDIF_3D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_p, tx_params, t, h, dz, dt, bcs);
        ...
        [N_test, TC_test] = RXDIF_3D_wAC(N0, kp_test, d_test, alpha1_test, alpha2_test, tx_params, t, h, dz, dt, bcs);
    ...
    if(ntp_pred ~= 0)
        N_pred = RXDIF_3D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_g, tx_params, tumor.t_scan(end), h, dz, dt, bcs);
        outputs.Pred = N_pred;
    end
