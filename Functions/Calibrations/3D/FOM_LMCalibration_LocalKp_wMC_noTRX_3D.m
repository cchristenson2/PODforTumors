...
function [params, stats, outputs, fig] = FOM_LMCalibration_LocalKp_wMC_noTRX_3D(tumor, ntp_cal, ntp_pred, bounds, dt, workers)
...
%     alpha2_g = alpha_up/2;
    ...
    %Initialize SSE
    [N_sim, TC] = RXDIF_3D_wMC(N0, kp_g, d_g, t, h, dz, dt, bcs, M, E, nu, matX, matY, matZ);
...
%             start = tic;
            ...
            parfor(i = 1:num_kp)
                ...
                N_kp    = RXDIF_3D_wMC(N0, kp_p, d_g, t, h, dz, dt, bcs, M, E, nu, matX, matY, matZ);
...
%             dif_alpha2 = alpha2_p - alpha2_g;
            ...
            N_d     = RXDIF_3D_wMC(N0, kp_g, d_p, t, h, dz, dt, bcs, M, E, nu, matX, matY, matZ);
...
%         end
        ...
        [N_test, TC_test] = RXDIF_3D_wMC(N0, kp_test, d_test, t, h, dz, dt, bcs, M, E, nu, matX, matY, matZ);
