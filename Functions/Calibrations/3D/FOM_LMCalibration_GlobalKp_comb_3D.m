...
function [params, stats, outputs] = FOM_LMCalibration_GlobalKp_comb_3D(tumor, ntp_cal, ntp_pred, bounds, dt)
...
%     alpha2_g = alpha_low * 5;
    ...
    %Initialize SSE
    [N_sim, TC] = RXDIF_3D_wAC_comb(N0, kp_g, d_g, alpha1_g, tx_params, t, h, dt, bcs);
...
%                 alpha2_p = alpha2_p*norm_alpha;
            ...
            N_kpp    = RXDIF_3D_wAC_comb(N0, kp_p, d_g, alpha1_g, tx_params, t, h, dt, bcs);
            N_dp     = RXDIF_3D_wAC_comb(N0, kp_g, d_p, alpha1_g, tx_params, t, h, dt, bcs);
...
%             alpha2_test = alpha2_test*norm_alpha;
        ...
        [N_test, TC_test] = RXDIF_3D_wAC_comb(N0, kp_test, d_test, alpha1_test, tx_params, t, h, dt, bcs);
...
%         alpha2_g = alpha2_g*norm_alpha;
    ...
    if(ntp_pred ~= 0)
        N_pred = RXDIF_3D_wAC_comb(N0, kp_g, d_g, alpha1_g, tx_params, tumor.t_scan(end), h, dt, bcs);
        outputs.Pred = N_pred;
    end
