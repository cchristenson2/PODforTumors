...
function [params, stats, outputs, fig, temp] = ROM_LMCalibration_LocalKp_noTRX_3D_v1(tumor, ntp_cal, ntp_pred, bounds, k, A_lib, B_lib, H_lib, T_lib, dt)
...
%         [Ta_r,~] = OperatorInterp_T(alpha1_g, alpha2_g, bounds, Tr_lib);
        ...
        N_pred_full = RXDIF_3D(N0, kp_g, d_g, tumor.t_scan(end), h, dt, bcs);
