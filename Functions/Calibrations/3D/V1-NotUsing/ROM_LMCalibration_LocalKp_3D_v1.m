...
function [params, stats, outputs, fig, temp] = ROM_LMCalibration_LocalKp_3D_v1(tumor, ntp_cal, ntp_pred, bounds, k, A_lib, B_lib, H_lib, T_lib, dt)
...
%         H_test = V'*H_f*kron(V,V);
    ...
    if(ntp_pred ~= 0)
        ...
        N_pred_full = RXDIF_3D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_g, tx_params, tumor.t_scan(end), h, dt, bcs);
