...
function [params, stats, outputs, fig, temp] = ROM_LMCalibration_LocalKp_wMC_comb_3D(tumor, ntp_cal, ntp_pred, bounds, k, A_lib, B_lib, H_lib, T_lib, dt, workers)
...
%     B_g = V'*B_f*V;
    ...
    %Initialize SSE
    [N_g_r, TC] = OperatorRXDIF_3D_wMC_wAC_comb(N0_r, A_g, B_g, H_g, Ta_g, tx_params, t, dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);
...
%             start = tic;
            parfor(i = 1:num_kp)
                ...
                N_kp = OperatorRXDIF_3D_wMC_wAC_comb(N0_r, A_g, B_t, H_t, Ta_g, tx_params, t, dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);
...
%             end
            ...
            N_d = OperatorRXDIF_3D_wMC(N0_r, A_t, B_g, H_g, Ta_g, tx_params, t, dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);
            ...
            N_alpha1 = OperatorRXDIF_3D_wMC_wAC(N0_r, A_g, B_g, H_g, Ta_t, tx_params, t, dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);
...
%         H_test = V'*H_f*kron(V,V);
        ...
        [N_test, TC_test] = OperatorRXDIF_3D_wMC_wAC_comb(N0_r, A_test, B_test, H_test, Ta_test, tx_params, t, dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);       
...
%         alpha2_store = [alpha2_store, alpha2_g];
    ...
    if(ntp_pred ~= 0)
        ...
        N_pred_r = OperatorRXDIF_3D_wMC_wAC_comb(N0_r, A_r, B_r, H_r, Ta_r, tx_params, tumor.t_scan(end), dt, M_r, E, nu, matX, matY, matZ, matX_r, matY_r, matZ_r, matXYZ, V, V_s, 1, bcs, h, dz);
        N_pred_r_reshape = reshape(V*N_pred_r, size(N0));
        
        %Option 2: predict in full state with found parameters
        N_pred_full = RXDIF_3D_wMC_wAC_comb(N0, kp_g, d_g, alpha1_g,tx_params, tumor.t_scan(end), h, dz, dt, bcs, M, E, nu, matX, matY, matZ);
