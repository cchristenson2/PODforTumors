...
function [params, stats, outputs, fig] = FOM_LMCalibration_LocalKp_2D(tumor, ntp_cal, ntp_pred, bounds, dt)
...
%     alpha2_g   = exp(log(alpha_low) + (log(alpha_up)-log(alpha_low)) * rand(1,1));
    ...
    %Initialize SSE
    [N_sim, TC] = RXDIF_2D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_g, tx_params, t, dt, bcs);
...
%             start = tic;
            ...
            parfor(i = 1:num_kp)
                ...
                N_kp    = RXDIF_2D_wAC(N0, kp_p, d_g, alpha1_g, alpha2_g, tx_params, t, dt, bcs);
...
%             end
            ...
            N_d     = RXDIF_2D_wAC(N0, kp_g, d_p, alpha1_g, alpha2_g, tx_params, t, dt, bcs);
            N_alpha1 = RXDIF_2D_wAC(N0, kp_g, d_g, alpha1_p, alpha2_g, tx_params, t, dt, bcs);
            N_alpha2 = RXDIF_2D_wAC(N0, kp_g, d_g, alpha1_p, alpha2_g, tx_params, t, dt, bcs);
        ...
        [N_test, TC_test] = RXDIF_2D_wAC(N0, kp_test, d_test, alpha1_test, alpha2_test, tx_params, t, dt, bcs);
    ...
    if(ntp_pred ~= 0)
        N_pred = RXDIF_2D_wAC(N0, kp_g, d_g, alpha1_g, alpha2_g, tx_params, tumor.t_scan(end), dt, bcs);
        outputs.Pred = N_pred;
    end
