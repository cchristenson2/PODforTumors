...
function [params, stats, outputs, fig, temp] = ROM_LMCalibration_LocalKp_wMC_2D(tumor, ntp_cal, ntp_pred, bounds, k, A_lib, B_lib, H_lib, T_lib, dt)
%     addpath(genpath('C:/ROM/'))
    ...
    [N_aug,kp_aug] = Augment_wMC_wTRX_2D(cat(3,N0,N_true), tumor.t_scan(2:end), h, 1, bcs, bounds, ntp_cal, tx_params, M, E, nu, matX, matY);
...
%     kron_proj = kron(V,V);
    ...
    %Initialize SSE
    [N_g_r, TC] = OperatorRXDIF_2D_wMC_wAC(N0_r, A_g, d_g, B_g, H_g, Ta_g, Tc_g, tx_params, t, dt, M_r, E_r, nu, matX_r, matY_r);
...
%             start = tic;
            parfor(i = 1:num_kp)
                ...
                N_kp = OperatorRXDIF_2D_wMC_wAC(N0_r, A_g, d_g, B_t, H_t, Ta_g, Tc_g, tx_params, t, dt, M_r, E_r, nu, matX_r, matY_r);
...
%             end
            ...
            N_d = OperatorRXDIF_2D_wMC_wAC(N0_r, A_t, d_p, B_g, H_g, Ta_g, Tc_g, tx_params, t, dt, M_r, E_r, nu, matX_r, matY_r);
            ...
            N_alpha1 = OperatorRXDIF_2D_wMC_wAC(N0_r, A_g, d_g, B_g, H_g, Ta_t, Tc_t, tx_params, t, dt, M_r, E_r, nu, matX_r, matY_r);
...
%         H_test = V'*H_f*kron(V,V);
        ...
        [N_test, TC_test] = OperatorRXDIF_2D_wMC_wAC(N0_r, A_test, d_test, B_test, H_test, Ta_test, Tc_test, tx_params, t, dt, M_r, E_r, nu, matX_r, matY_r);       
...
%             [update,flags] = bicgstab((J'*J + lambda*diag(diag(J'*J))),(J'*residuals),1e-8,100);
    ...
    if(ntp_pred ~= 0)
        ...
        N_pred_r = OperatorRXDIF_2D_wMC_wAC(N0_r, A_r, d_g, B_r, H_r, Ta_r, Tc_r, tx_params, tumor.t_scan(end), dt, M_r, E_r, nu, matX_r, matY_r);
