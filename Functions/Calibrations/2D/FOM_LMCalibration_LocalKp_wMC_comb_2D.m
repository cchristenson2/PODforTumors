...
function [params, stats, outputs, fig] = FOM_LMCalibration_LocalKp_wMC_comb_2D(tumor, ntp_cal, ntp_pred, bounds, dt)
%     addpath(genpath('C:/ROM/'))
    ...
    [~,kp_aug] = Augment_wMC_comb_2D(cat(3,N0,N_true), tumor.t_scan(2:end), h, 1, bcs, bounds, ntp_cal, tx_params, M, E, nu, matX, matY);
%     kp_g = kp_aug;
...
%     alpha2_g = alpha_low * 5;
    ...
    %Initialize SSE
    [N_sim, TC] = RXDIF_2D_wMC_comb(N0, kp_g, d_g, alpha1_g, tx_params, t, h, dt, bcs, M, E, nu, matX, matY);
...
%             start = tic;
            ...
            parfor(i = 1:num_kp)
                ...
                N_kp    = RXDIF_2D_wMC_comb(N0, kp_p, d_g, alpha1_g, tx_params, t, h, dt, bcs, M, E, nu, matX, matY);
...
%             dif_alpha2 = alpha2_p - alpha2_g;
            ...
            N_d     = RXDIF_2D_wMC_comb(N0, kp_g, d_p, alpha1_g, tx_params, t, h, dt, bcs, M, E, nu, matX, matY);
            N_alpha1 = RXDIF_2D_wMC_comb(N0, kp_g, d_g, alpha1_p, tx_params, t, h, dt, bcs, M, E, nu, matX, matY);
...
%         end
        ...
        [N_test, TC_test] = RXDIF_2D_wMC_comb(N0, kp_test, d_test, alpha1_test, tx_params, t, h, dt, bcs, M, E, nu, matX, matY);
...
%         alpha2_store = [alpha2_store, alpha2_g];
    ...
    if(ntp_pred ~= 0)
        N_pred = RXDIF_2D_wMC_comb(N0, kp_g, d_g, alpha1_g, tx_params, tumor.t_scan(end), h, dt, bcs, M, E, nu, matX, matY);
        outputs.Pred = N_pred;
    end
