...
function [params, stats, outputs, fig] = FOM_LMCalibration_LocalKp_wMC_noTRX_2D(tumor, ntp_cal, ntp_pred, bounds, dt)
...
%     [~,kp_aug] = Augment_wMC_noTRX_2D(cat(3,N0,N_true), tumor.t_scan(2:end), h, 1, bcs, bounds, ntp_cal, tx_params, M, E, nu, matX, matY);
%     kp_g = kp_aug;
