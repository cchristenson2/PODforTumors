...
function [params, stats, outputs] = ROM_LMCalibration_GlobalKp_comb_2D(tumor, ntp_cal, ntp_pred, bounds, k, A_lib, B_lib, H_lib, T_lib, dt)
...
%         alpha2_g = alpha2_g*norm_alpha;
    ...
    if(ntp_pred ~= 0)
        ...
        N_pred_full = RXDIF_2D_wAC_comb(N0, kp_g*ones(size(N0)), d_g, alpha1_g, tx_params, tumor.t_scan(end), h, dt, bcs);
