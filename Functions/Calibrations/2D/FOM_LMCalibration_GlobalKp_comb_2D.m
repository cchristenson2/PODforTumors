...
function [params, stats, outputs] = FOM_LMCalibration_GlobalKp_comb_2D(tumor, ntp_cal, ntp_pred, bounds, dt)
...
%                 alpha2_p = alpha2_p*norm_alpha;
            ...
            N_kpp    = RXDIF_2D_wAC_comb(N0, kp_p, d_g, alpha1_g, tx_params, t, h, dt, bcs);
            N_dp     = RXDIF_2D_wAC_comb(N0, kp_g, d_p, alpha1_g, tx_params, t, h, dt, bcs);
