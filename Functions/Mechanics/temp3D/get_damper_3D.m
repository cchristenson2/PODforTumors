function [damper, s_xx, s_yy, s_zz, s_xy, s_xz, s_yz] = get_damper_3D(matX, matY, matZ, N, M, E, nu, h, dz)
    [sy,sx,sz] = size(N);
...
%     [e_xx,e_yy,e_zz,e_xy,e_xz,e_yz] = strains(Um, h, h, dz);
    ...
    [s_xx,s_yy,s_zz,s_xy,s_xz,s_yz,s_vm] = stresses(e_xx,e_yy,e_zz,e_xy,e_xz,e_yz, E, nu);
