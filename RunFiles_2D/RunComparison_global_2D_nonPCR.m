...
for i = 3:numel(files)
    ...
    [FOM,ROM, tumor] = calibrationComparison_global_2D(file_loc, cal_flag, bounds, name);
    save([home,'/Results/nonpcr/',erase(name,'.mat'),'_GlobalCalibration_2D'], 'FOM', 'ROM', 'tumor');
