...
bounds = [1e-6, 1e-1; 1e-3, 1e-1]; %Diffusivity; proliferation
...
%{
Notes: The total time for ROM 

If we have to perform at least 2 runs of the FOM, the time added by building
